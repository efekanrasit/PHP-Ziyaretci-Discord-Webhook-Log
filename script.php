...
class geoPlugin {
	...
	function fetch($host) {
		if ( function_exists('curl_init') ) {			
			...
			trigger_error ('geoPlugin class Error: Veriye erişilemedi, PHPnizin cURL desteği olup olmadığını ve .ini dosyasında allow_url_fopen in aktif olup olmadığını kontrol ediniz. ', E_USER_ERROR);
			return;
		}
		return $response;
	}
